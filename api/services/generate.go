...
//go:generate go run git.sr.ht/~sircmpwn/gqlclient/cmd/gqlclientgen -a -n gql_builds_gen -s $ASSETS/builds.sr.ht.graphqls -q builds/queries.graphql -o builds/gql.go
